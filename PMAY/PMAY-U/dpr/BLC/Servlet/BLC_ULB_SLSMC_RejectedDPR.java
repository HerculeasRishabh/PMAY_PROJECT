...
import dpr.BLC.connection.DPR_BLC_connection;

/**
 * Servlet implementation class BLC_ULB_SLSMC_RejectedDPR
 */
@WebServlet("/BLC_ULB_SLSMC_RejectedDPR")
public class BLC_ULB_SLSMC_RejectedDPR extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BLC_ULB_SLSMC_RejectedDPR() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String SLSMC_FEEDBACK = request.getParameter("SLSMCFeedback");
        ...
        obj.blc_DPR_Update_IA_SLSMC_Reject(STATE, DISTRICT, CITY, PORJECT_NM, SLNA_NM, IA_NAME, PROJECT_COST, GEN_OLD, SC_OLD, 
                ...
                GEO_TAGGING_DPR, GREEN_TECH, OTHER_INFO, DGTL_SIGN_ULB, BLC_PROJECT_NO, SLSMC_FEEDBACK);
