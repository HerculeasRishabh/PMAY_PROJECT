...
<div style="margin-top: 50px; border: 1px solid black; width: 500px; margin-left: 50px; height: 350px; width: 690px;" id="d1">
      		...
      		<form style="margin-top: 50px; width: 500px; " id = "Search_By_Aadhar" action = "http://localhost:8080/PMAY/PMAY-U/GeneralContent/4bSelectByAadhar.jsp" method = "POST">
			...
			<form style="margin-top: 50px; width: 500px; " action = "http://localhost:8080/PMAY/PMAY-U/GeneralContent/4bSelectByName.jsp" method = "POST">
