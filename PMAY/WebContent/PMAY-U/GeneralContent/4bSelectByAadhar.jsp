...
<jsp:include page = "../Headers/IA_Header.jspf"/>
        ...
        <nav style="margin-top: -10px; width: 80%; margin-left: 10%" class="topHead">
	        <div class="nav-wrapper " style=" background-color: #bf360c ;">
	          <ul>
	          	<center>
	          		<h4 style= "font-size:20px; padding-top: 20px;" >Complete list of General Beneficiary</h4>
	          	</center>
	          </ul>
	        </div>
	      </nav>
        ...
        <br>
        <%
        	String Aadhar_no = request.getParameter("benAadhar");
        	BEN_GNRL_Registration obj = new BEN_GNRL_Registration ();
        	ResultSet RS = null;
        	RS = obj.selectRecord4B_Aadhar(Aadhar_no);
        %>
