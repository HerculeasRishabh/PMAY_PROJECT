  ...
  <jsp:include page = "../../Headers/IA_Header.jspf"/>
    ...
    <nav style="margin-top: -10px; width: 80%; margin-left: 10%" class="topHead">
        <div class="nav-wrapper " style=" background-color: #bf360c ;">
          <ul>
          	<center>
          		<h4 style= "font-size:20px; padding-top: 20px;" >In-Situ Slum Redevelopment DPR</h4>
          	</center>
          </ul>
        </div>
      </nav>
      
	      <form style="margin-left: 11%" name="inSitu" action = "http://localhost:8080/PMAY/InSitu_ULB_DPR_Insert" method = "POST" class="inSituForm">
	        <div class="row">
