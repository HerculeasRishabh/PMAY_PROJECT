...
<html>
  <head>
    <meta charset="utf-8">
    <title>Search Beneficiary InSitu</title>
...
<jsp:include page = "../../Headers/IA_Header.jspf"/>
		...
		<nav style="margin-top: -10px; width: 80%; margin-left: 10%" class="topHead">
	        <div class="nav-wrapper " style=" background-color: #bf360c ;">
	          <ul>
	          	<center>
	          		<h4 style= "font-size:20px; padding-top: 20px;" >Search Beneficiary InSitu</h4>
	          	</center>
	          </ul>
	        </div>
	      </nav>
...
<div style="margin-top: 50px; border: 1px solid black; width: 500px; margin-left: 50px; height: 350px; width: 690px;" id="d1">
      		...
      		<form style="margin-top: 50px; width: 500px; " id = "Search_By_Aadhar" action = "http://localhost:8080/PMAY/PMAY-U/ImplementationAgency/Beneficiary_InSitu/4aSelectByAadhar.jsp" method = "POST">
            	 ...
            	 <input style="width:100px;  height:50px; background: #f4511e; color: white; text-align: center; " type="submit" value="Search">
			...
			<form style="margin-top: 50px; width: 500px; " action = "http://localhost:8080/PMAY/PMAY-U/ImplementationAgency/Beneficiary_InSitu/4aSelectByName.jsp" method = "POST">
	...
	<div style="margin-top: 50px;  width: 500px; margin-left: 50px; height: auto; width: 690px; margin-bottom:30px;">
			...
			<form action = "http://localhost:8080/PMAY/PMAY-U/ImplementationAgency/Beneficiary_InSitu/4aSelectAllEdit.jsp" method = "POST">
